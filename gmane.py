...
# may need for windows:  import collections
# may need for windows:  collections.Callable = collections.abc.Callable
# may also need to type "chcp 65001" in the command line
import re
